      ...
      <div className="w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
          <div className="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
            ...
            <div className="my-10">
              ...
              <h3 className="text-2xl font-semibold">Location : {details.Location} </h3>
          ...
          <div className="">
              ...
              <div className="w-1/2">
                <h3 className="text-2xl font-semibold">{details.Name} detected at {details.Location} on { details.Date}</h3>
            </div>
          </div>
